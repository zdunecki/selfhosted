...
func (a *ExampleCustomApp) Install(config *apps.InstallConfig) error {
...
func (a *ExampleCustomApp) SetupSSL(config *apps.InstallConfig) error { return nil }
...
func init() {
	...
	apps.Register(&ExampleCustomApp{})
}
